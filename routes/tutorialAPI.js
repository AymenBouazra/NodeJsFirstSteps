...
router.delete('/tutorial/:id',passport.authenticate('bearer',{session:false}), async (req, res) => {
  ...
  router.put('/tutorial/affectTag/:idTag/:idTuto',passport.authenticate('bearer',{session:false}), async (req, res) => {
  ...
  router.put('/tutorial/disaffectTag/:idTag/:idTuto',passport.authenticate('bearer',{session:false}), async (req, res) => {
